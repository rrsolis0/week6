...
# print(tuple4.index(3)) #Output: 2
# print(tuple4.index('cherry')) #Output: 2
# print(tuple4.index('banana')) #Output: 4
...
print(sample_list[0][-1]) # Output: 3
